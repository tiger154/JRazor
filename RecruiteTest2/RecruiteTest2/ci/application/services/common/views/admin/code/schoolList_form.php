							...
							<form id="top-sch" name="top-sch" method="get" action="/admin/codeManagement/schoolManagerList">
								...
								<fieldset>
									...
									<legend>게시물 검색</legend>
										...
										<input type="text" name="sch_sch_nm" id="sch_sch_nm" title="검색어입력" style="width:100px" value="<?=$sch_sch_nm?>"/>
					...
					<table id="BdList-Type01" summary="목록">
						...
						?>
							<tr>
								...
								<td><?=$data->REG_DT?></td>
								<td><span class="btn03"><a href="javascript:modifyProcess('<?=$data->SCH_IDX?>');">수정</a></span></td>
								<td><span class="btn04"><a href="javascript:deleteProcess('<?=$data->SCH_IDX?>');">삭제</a></span></td>
							</tr>
						<?} 
