...
<script>
	...
	function commentProcess()
	{
		...
		$("#form1").attr("action","/admin/siteContent/commentSubProcess");
		$("#form1").submit();
	}
...
기본 컨텐츠 항목 : <?=$SELECTBOX_SEL_DFC_CD?>
<br>
...
(본기능은 사이트에 새로운 항목이 생겨서 별도 작업이 필요할때 사용합니다. - 개발자와 협의후 추가하세요.)
 ...
 fOnAppLoad : function(){
		oEditors.getById["DFC_CNTNT"].exec("PASTE_HTML", [$("#DFC_CNTNT_FOR_CONTENT").val()]);
					...
					<div class="txtC">
						...
						<span class="btn02"><a href="javascript:goLink('/admin/siteContent/resumeSubList')">돌아가기</a></span>
					</div>
