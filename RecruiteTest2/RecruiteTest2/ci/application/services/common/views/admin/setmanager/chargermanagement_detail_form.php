...
<script>
    ...
    messages: {
    		...
    		MANAGER_PW:{
    			...
    			minlength:"최소 6자 이상입니다."
    		},
    		MANAGER_PWRE:{
    			required:"비밀번호를 입력하세요",
    			minlength:"최소 6자 이상입니다.",
    			equalto:"비밀번호가 일치가하지 않습니다."
    		},
	...
	{
		$("#form1").attr("action","/admin/chargerManagement/managerProcess");
		$("#submit_button").click();
...
<form name="form1" id="form1" method="post">
			<table class="BdView-Type01" summary="관리자 관리">
				...
				<tbody>
					<tr>
						<th scope="row">
							<label for="select"><span class="item">*</span>계정 구분</label>
						</th>
						<td>
							<?=$SELECTBOX_MANAGER_TP?>
							<label class="error" for="MANAGER_TP" generated="true" style="display:none;color:red;">error message</label>
						</td>
					</tr>
					<? if ($MANAGER_ID != null) { ?>
					<tr>
