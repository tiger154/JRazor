...
class CI_Pagination {
	...
	var $first_link			= '<img src="/assets/img/btn/list_first.gif" alt="첫 페이지이동" />';
	var $next_link			= '<img src="/assets/img/btn/list_next.gif" alt="다음10개 페이지이동" />';
	var $prev_link			= '<img src="/assets/img/btn/list_prev.gif" alt="이전10개 페이지이동" />';
	var $last_link			= '<img src="/assets/img/btn/list_last.gif" alt="마지막 페이지이동" />';
	var $first_link_disable	= '<img src="/assets/img/btn/list_first.gif" alt="첫 페이지이동" />';
	var $next_link_disable	= '<img src="/assets/img/btn/list_next.gif" alt="다음10개 페이지이동" />';
	var $prev_link_disable	= '<img src="/assets/img/btn/list_prev.gif" alt="이전10개 페이지이동" />';
	var $last_link_disable	= '<img src="/assets/img/btn/list_last.gif" alt="마지막 페이지이동" />';
	var $uri_segment		= 4;
	var $full_tag_open		= '';
	var $full_tag_close		= '';
	var $first_tag_open		= '';
